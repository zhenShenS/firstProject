...
<body>
	...
	<form action="service/1/selectFp" name="frm" method="post">
		<table class="query_form_table" cellSpacing=1 cellPadding=1>
			<tr>
				<td width=100% height=30 align=left
					background="images/m_table_top.jpg" colspan="6"><strong>&nbsp;服务处理</strong></td>
			</tr>
			<tr>
				<th height="28">客户</th>
	...
	<table id="data_list_table" class="data_list_table" cellSpacing=1
		...
		<c:forEach items="${sessionScope.pageInfo.list}" var="page">
			<tr>
				...
				<td><a href="service/${page.svrId}/deal_detail"> <img src="images/bt_deal.gif"
						class="op_button" />
				</a></td>
			</tr>
		</c:forEach>
			...
			<th colspan="8" align="center">共${sessionScope.pageInfo.total}条记录
				每页 8 条 第页 <a href="service/toShowAddService">首页</a> <c:choose>
					<c:when test="${sessionScope.pageInfo.hasPreviousPage}">
						<a href="service/${sessionScope.pageInfo.prePage}/findAllFp">上一页</a>
					</c:when>
					<c:otherwise>
					...
					<c:when test="${sessionScope.pageInfo.hasNextPage}">
						<a href="service/${sessionScope.pageInfo.nextPage}/findAllFp">下一页</a>
					</c:when>
					<c:otherwise>
