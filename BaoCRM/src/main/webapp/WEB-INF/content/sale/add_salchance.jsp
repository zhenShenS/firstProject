...
<body>
	...
	<form action="sale/save_salchance_controller" method="post">
		<table class="query_form_table" cellSpacing=1 cellPadding=1>
			...
			<tr>
				<th>编号</th>
				<td><input type="text" name="chcId" /></td>
				<th>机会来源</th>
			...
			<tr>
				<th>创建人</th>
				<td><!-- <input name="chcCreatBy"
					value="" size="20" /> -->
					<input type="text" name="chcCreatBy" size="20" /><span
					class="red_star">*</span></td>
			</tr>
			<tr>
