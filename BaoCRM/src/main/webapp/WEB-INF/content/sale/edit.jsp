		...
		<table class="query_form_table" cellSpacing=1 cellPadding=1>
			...
			<tr>
				...
				<td><input readonly name="chcId"
					value="${sessionScope.findOneSalChance.chcId}" /></td>
				<th>机会来源</th>
				<td><input type="text" name="chcSource"
					value="${sessionScope.findOneSalChance.chcSource}" size="20" /></td>
			</tr>
			<tr>
				<th>客户名称</th>
				<td><input type="text" name="chcCustName"
					value="${sessionScope.findOneSalChance.chcCustName}" /><span
					class="red_star">*</span></td>
				<th>成功机率（%）</th>
				<td><input type="text" name="chcRate"
					value="${sessionScope.findOneSalChance.chcRate}" /><span class="red_star">*</span></td>
			</tr>
			<tr>
				<th>概要</th>
				<td colspan="3"><input type="text" name="chcTitle"
					value="${sessionScope.findOneSalChance.chcTitle}" size="52" /><span
					class="red_star">*</span></td>
			</tr>
			<tr>
				<th>联系人</th>
				<td><input type="text" name="chcLinkman"
					value="${sessionScope.findOneSalChance.chcLinkman}" size="20" /></td>
				<th>联系人电话</th>
				<td><input type="text" name="chcTel"
					value="${sessionScope.findOneSalChance.chcTel}"  size="20" /></td>
			</tr>
			<tr>
				<th>机会描述</th>
				<td colspan="3"><textarea rows="6" cols="50" type="text"
						name="chcDesc">${sessionScope.findOneSalChance.chcDesc}</textarea><span
					class="red_star">*</span></td>
			</tr>
			<tr>
				<th>创建人</th>
				<td colspan="3"><input name="chcCreateBy"
					value="${sessionScope.findOneSalChance.chcCreateBy}" readonly size="20" /><span
					class="red_star">*</span></td>
			</tr>
