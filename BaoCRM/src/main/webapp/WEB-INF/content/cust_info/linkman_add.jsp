...
<form action="controller/linkMan_add_behind" method="post" onsubmit="return linkman_addcheck()">
...
<table class="query_form_table">
	...
	<tr>
		<th>职位</th>
		<td><input type="text" name="lkmPostion" id="lkmPostion"/><span class="red_star" id="lkm_postionspan">*</span></td>
		<th>办公电话</th>
		<td><input type="text" name="lkmTel" id="lkmTel"/><span class="red_star" id="lkm_telspan">*</span></td>
	</tr>	
	<tr>
		<th>手机</th>
