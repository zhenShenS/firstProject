...
<body>
	...
	<table id="data_list_table" class="data_list_table" cellSpacing=1
		...
		<tr>
		 ...
		 <c:forEach items="${sessionScope.pageInfo}" var="pi" varStatus="i">
		<tr>
			<td class="list_data_number">${i.count}</td>
			<td class="list_data_text">${pi.custId}</td>
			<td class="list_data_ltext">${pi.custName}</td>
			<td class="list_data_text">${pi.custAddr}</td>
			<td class="list_data_text">${pi.custManagerName}</td>
			<td class="list_data_text">${pi.custLevelLabel}</td>
