													...
													<TABLE cellSpacing=0 cellPadding=0 width="90%" align=center
														...
														<TBODY>
															<TR>
																...
																<TD class=unnamed1><a href="sale/1/showAllSaleChance" target="mainFrame">销售机会管理</a></TD>
															</TR>
														</TBODY>
													</TABLE>
												</TD>
													...
													<table cellSpacing=0 cellPadding=0 width="90%" align=center
														...
														<tbody>
															<tr>
																...
																<TD class=unnamed1><a href="sale/1/dev" target="mainFrame">客户开发计划</a></TD>
															</TR>
														</TBODY>
													</TABLE>
												</TD>
													...
													<TABLE cellSpacing=0 cellPadding=0 width="90%" align=center
														...
														<TBODY>
															<TR>
																...
																<TD class=unnamed1><a href="cust/1/findAllCust" target="mainFrame">客户信息管理</a></TD>
															</TR>
														</TBODY>
													</TABLE>
												</TD>
					...
					<TABLE cellSpacing=0 cellPadding=0 width=156 bgColor=#d3dae1
						...
						<TBODY>
							...
							<TR id=tr1_2 style="DISPLAY: none">
								<TD class=buttom_lr_line style="BACKGROUND-COLOR: #fafcff">
									<c:choose>
										<c:when test="${sessionScope.user.usrRoleId==2||sessionScope.user.usrRoleId==4 }">
										<TABLE class=buttom_line
										onMouseOver="this.style.cursor='hand';"
										onmouseout="this.style.cursor='auto';" cellSpacing=0
										cellPadding=0 width=152 align=center border=0>
													...
													<TABLE cellSpacing=0 cellPadding=0 width="90%" align=center
														...
														<TBODY>
															<TR>
																...
																<TD class=unnamed1><a href="service/toShowAddService" target="mainFrame">服务创建</a></TD>
															</TR>
														</TBODY>
													</TABLE>
												</TD>
									...
									<c:choose>
										<c:when test="${sessionScope.user.usrRoleId==2||sessionScope.user.usrRoleId==3}">
											<TABLE class=buttom_line
										onMouseOver="this.style.cursor='hand';"
										onmouseout="this.style.cursor='auto';" cellSpacing=0
										cellPadding=0 width=152 align=center border=0>
													...
													<TABLE cellSpacing=0 cellPadding=0 width="90%" align=center
														...
														<TBODY>
															<TR>
																...
																<TD class=unnamed1><a href="service/1/findAllService" target="mainFrame">服务分配</a></TD>
															</TR>
														</TBODY>
													</TABLE>
												</TD>
													...
													<TABLE cellSpacing=0 cellPadding=0 width="90%" align=center
														...
														<TBODY>
															<TR>
																...
																<TD class=unnamed1><a href="service/1/findAllFp" target="mainFrame">服务处理</a></TD>
															</TR>
														</TBODY>
													</TABLE>
												</TD>
													...
													<TABLE cellSpacing=0 cellPadding=0 width="90%" align=center
														...
														<TBODY>
															<TR>
																...
																<TD class=unnamed1><a href="service/1/findFeedback" target="mainFrame">服务反馈</a></TD>
															</TR>
														</TBODY>
													</TABLE>
												</TD>
													...
													<TABLE cellSpacing=0 cellPadding=0 width="90%" align=center
														...
														<TBODY>
															<TR>
																...
																<TD class=unnamed1><a href="chart/cstContribute" target="mainFrame">客户贡献分析</a></TD>
															</TR>
														</TBODY>
													</TABLE>
												</TD>
													...
													<TABLE cellSpacing=0 cellPadding=0 width="90%" align=center
														...
														<TBODY>
															<TR>
																...
																<TD class=unnamed1><a href="chart/constitute" target="mainFrame">客户构成分析</a></TD>
															</TR>
														</TBODY>
													</TABLE>
												</TD>
													...
													<TABLE cellSpacing=0 cellPadding=0 width="90%" align=center
														...
														<TBODY>
															<TR>
																...
																<TD class=unnamed1><a href="product/1/toproduct" target="mainFrame">查询产品信息</a></TD>
															</TR>
														</TBODY>
													</TABLE>
												</TD>
													...
													<TABLE cellSpacing=0 cellPadding=0 width="90%" align=center
														...
														<TBODY>
															<TR>
																...
																<TD class=unnamed1><a href="product/1/storage" target="mainFrame">查询库存</a></TD>
															</TR>
														</TBODY>
													</TABLE>
												</TD>
													...
													<TABLE cellSpacing=0 cellPadding=0 width="90%" align=center
														...
														<TBODY>
															<TR>
																...
																<TD class=unnamed1><a href="role/1/toShowAllRole" target="mainFrame">角色管理</a></TD>
															</TR>
														</TBODY>
													</TABLE>
												</TD>
													...
													<TABLE cellSpacing=0 cellPadding=0 width="90%" align=center
														...
														<TBODY>
															<TR>
																...
																<TD class=unnamed1><a href="sysUser/1/showAllUser" target="mainFrame">用户管理</a></TD>
															</TR>
														</TBODY>
												</TABLE>
												</TD>
													...
													<TABLE cellSpacing=0 cellPadding=0 width="90%" align=center
														...
														<TBODY>
															<TR>
																...
																<TD class=unnamed1><a href="log/1/reviewLog" target="mainFrame">日志查看</a></TD>
															</TR>
														</TBODY>
													</TABLE>
												</TD>
