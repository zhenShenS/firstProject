...
<body>
   <table width="100%" cellSpacing=0 cellPadding=0 border="0px">
	...
	<form action="systemset/updateUser" method="post">
		...
		<table class="query_form_table" cellSpacing=1 cellPadding=1>
			...
			<tr>
				...
				<td><input readonly="readonly" name="usrId" type="text"
					value="${sessionScope.oneUser.usrId}" /> 
			...
			<tr>
				...
				<td><input type="text" name="usrName"
					value="${sessionScope.oneUser.usrName}" /><span class="red_star">*</span></td>

			</tr>
			<tr>
				<th>密码</th>
				<td><input type="text" name="usrPassword"
					value="${sessionScope.oneUser.usrPassword}"><span class="red_star">*</span></td>
			</tr>
			<tr>
				<th>状态</th>
				<td colspan="3"><input name="usrFlag" type="radio"
					value="${sessionScope.oneUser.usrFlag}" checked="checked" />有效 <input
