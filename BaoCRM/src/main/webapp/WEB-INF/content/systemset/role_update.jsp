		...
		<table class="query_form_table" cellSpacing=1 cellPadding=1>
			...
			<tr>
				...
				<td><input readonly="readonly" name="roleId" type="text"
					value="${sessionScope.oneRole.roleId}" /></td>
			</tr>
			<tr>
				<th>角色名</th>
				<td><input type="text" name="roleName"
					value="${sessionScope.oneRole.roleName}" /><span class="red_star">*</span></td>

			</tr>
			<tr>
				<th>描述</th>
				<td><textarea cols="50" rows="4" name="roleDesc">${sessionScope.oneRole.roleDesc}</textarea><span
			...
			<tr>
				...
				<input name="role_flag" type="radio" value="1"
					checked="checked" />有效 
				<input name="roleFlag" type="radio"
					value="0" />无效</td>
			</tr>
			<tr>
