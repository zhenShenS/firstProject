...
<body>
	...
	<form action="product/1/findProductByCon" method="post">
	...
	<table id="data_list_table" class="data_list_table" cellSpacing=1
		...
		<tr>
			<th colspan="7" class="pager" ><!-- align="right"
				...
				<div class="pager">
					第${pageInfo.pageNum}页 <a href="product/1/toShowProduct">首页</a>
					<c:choose>
						<c:when test="pageInfo.hasPreviousPage">
							 <a href="product/${pageInfo.prePage}/toShowProduct">上一页</a> 
						</c:when>
						<c:otherwise>
					...
					<c:choose>
						<c:when test="${pageInfo.hasNextPage }">
							<a href="product/${pageInfo.nextPage}/toShowProduct">下一页</a>
						</c:when>
						<c:otherwise>
							<font color="#ABA8AB">下一页</font>
						</c:otherwise>
					</c:choose>
					  <a href="product/${pageInfo.lastPage}/toShowProduct">尾页</a>
				</div>
			</th>
		</tr>
	</table>
