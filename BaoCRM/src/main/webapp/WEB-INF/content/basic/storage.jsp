...
<body>
	...
	<form
		action="product/1/findStorageByCon"
		method="post">
			...
			<th colspan="6" class="pager"> <!-- align="right"
				...
				<div class="pager">
					第${pageInfo.pageNum}页
					 <a href="product/1/storage">首页</a>
				<c:choose>
					<c:when test="pageInfo.hasPreviousPage">
						<a href="product/${pageInfo.prePage}/storage">上一页</a>
					</c:when>
					<c:otherwise>
				...
				<c:choose>
					...
					<a href="product/${pageInfo.lastPage }/storage">尾页</a>
				</div>
			</th>
		</tr>
	</table>
